...
#patchDockerFiles .
VERSION=$REF make static-linux

cp docker-ce-packaging/static/build/linux/*.tgz $BUILD_OUT_DIR
#TODO rename docker docker-v20.10.8.tgz to docker-ppc64le.tgz 
#      and   docker-rootless-extras-v20.10.8.tgz to docker-rootless-extras-ppc64le.tgz 
#            when pushing to COS bucket
